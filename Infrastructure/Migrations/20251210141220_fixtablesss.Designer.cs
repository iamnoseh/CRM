...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251210141220_fixtablesss")]
    partial class fixtablesss
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Advance", b =>
                {
                    ...
                    b.HasIndex("TargetMonth", "TargetYear");
            ...
            modelBuilder.Entity("Domain.Entities.PayrollContract", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.PayrollRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("TotalStudentPayments")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
            ...
            modelBuilder.Entity("Domain.Entities.StudentAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.StudentGroup", b =>
                {
                    ...
                    b.Property<DateTime?>("LastPaymentReminderSentDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Domain.Entities.AccountLog", b =>
                {
                    b.HasOne("Domain.Entities.StudentAccount", "Account")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.Advance", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.PayrollRecord", "PayrollRecord")
                        .WithMany()
